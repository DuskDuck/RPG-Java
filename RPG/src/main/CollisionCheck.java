...
public class CollisionCheck {
	...
	public void checkTile(Character character) {
		...
		case "upright":
			...
			tile1 = gp.tile.mapTileNum[CharRightCol][CharTopRow];
			tile2 = gp.tile.mapTileNum[CharRightCol][CharBottomRow];
			tile3 = gp.tile.mapTileNum[CharRightCol][CharTopRow-1];
		...
		case "upleft":
			...
			tile1 = gp.tile.mapTileNum[CharLeftCol][CharTopRow];
			tile2 = gp.tile.mapTileNum[CharLeftCol][CharBottomRow];
			tile3 = gp.tile.mapTileNum[CharLeftCol][CharTopRow+1];
			if(gp.tile.tile[tile1].collision == true || gp.tile.tile[tile2].collision == true || gp.tile.tile[tile3].collision == true) {
				character.collisionOn = true;
			}
			break;
		case "downright":
			...
			tile1 = gp.tile.mapTileNum[CharRightCol][CharTopRow];
			tile2 = gp.tile.mapTileNum[CharRightCol][CharBottomRow];
			tile3 = gp.tile.mapTileNum[CharRightCol][CharBottomRow-1];
			if(gp.tile.tile[tile1].collision == true || gp.tile.tile[tile2].collision == true || gp.tile.tile[tile3].collision == true) {
				character.collisionOn = true;
			}	
			break;
		case "downleft":
			...
			tile1 = gp.tile.mapTileNum[CharLeftCol][CharTopRow];
			tile2 = gp.tile.mapTileNum[CharLeftCol][CharBottomRow];
			tile3 = gp.tile.mapTileNum[CharLeftCol][CharBottomRow+1];
			if(gp.tile.tile[tile1].collision == true || gp.tile.tile[tile2].collision == true || gp.tile.tile[tile3].collision == true) {
				character.collisionOn = true;
			}
			break;
